...
- It runs all frameworks and both sizes at `1` client before continuing with
  `2`, `4`, `8`, `16`, `32`, and `64` clients. Each client receives the same
  ten queries in an independently randomized order.
